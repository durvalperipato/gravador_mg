                    ...
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(newConfigViewModel.program
                                .toString()
                                .toUpperCase()),
                            SizedBox(
                              height: 30,
                            ),
                            Text('Buscando dispositivos conectados...'),
                          ],
                        ),
                      )
                    : newConfigViewModel.autoVerifyPortsDialog
                        ? Center(
                            child: AlertDialog(
                              title: Text('Iniciar a busca dos slots?'),
                              content: Text(newConfigViewModel.program),
                              actions: [
                                TextButton(
                                  child: Text('Auto'),
                                  onPressed: () {
                                    ...
                                    newConfigViewModel
                                        .verifyPorts(newConfigViewModel);
                                    Future.delayed(
                                      Duration(seconds: 3),
                                      () => newConfigViewModel.isVerifyPorts =
                                          false,
                                    );
                                  },
                                ),
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Checkbox(
                                                                  ...
                                                                  onChanged:
                                                                    ...
                                                                    setState(
                                                                        () {
                                                                      newConfigViewModel.slots['config']['SLOT ${index + 1}']
                                                                              [
                                                                              'active'] =
                                                                          value;
                                                                    });
